...
st.markdown("Store and retrieve important information about yourself and your preferences")
    ...
    with st.form("add_memory_form", clear_on_submit=True):
        ...
        if submit:
            if memory_text.strip():
                memory_id = memory.add_memory(memory_text.strip(), category=memory_category)
...
# Footer
st.markdown("---")
st.caption("💡 **Tip**: Be specific when adding memories - this helps Heathcliff understand you better!")
